...
export class Backend implements backendInterface {
    ...
    async getExhibitors(): Promise<Array<Exhibitor>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExhibitors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStallBookings(): Promise<Array<StallBooking>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStallBookings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async newsletterSignup(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.newsletterSignup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerExhibitor(arg0: Exhibitor): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.registerExhibitor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitStallBooking(arg0: StallBooking): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitStallBooking(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
